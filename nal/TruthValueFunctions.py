...
def Truth_revision(truth1: Truth, truth2: Truth):
    ...
    truth = Truth.from_w(w_p, w_m + w_p, truth1.k)
    return truth
...
def Truth_conversion(truth: Truth) -> Truth:
    ...
    return Truth.from_w(w_plus, w_plus + w_minus, truth.k)
...
Truth_abduction: TruthFunction = lambda truth1, truth2: Truth.from_w(
...
Truth_induction: TruthFunction = lambda truth1, truth2: Truth.from_w(
...
Truth_exemplification: TruthFunction = lambda truth1, truth2: Truth.from_w(
    *F_exemplification(truth1.f, truth1.c, truth2.f, truth2.c), truth1.k)
# def Truth_exemplification(truth1: Truth, truth2: Truth) -> Truth: 
#     return Truth.from_w(*F_exemplification(truth1.f, truth1.c, truth2.f, truth2.c), truth1.k)

# F_com
F_com = F_comparison = lambda f1, c1, f2, c2: (And(f1, f2, c1, c2), And(Or(f1, f2), c1, c2))  # return: w+, w
Truth_comparison: TruthFunction = lambda truth1, truth2: Truth.from_w(
